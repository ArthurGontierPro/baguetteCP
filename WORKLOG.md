...
| M2-T1, M2-T2 | new `lib/core/prop/bool_*.ml`, `lib/flatzinc/compile.ml`, `lib/flatzinc/model.ml`, `lib/flatzinc/builder.ml`, `test/unit/test_compile.ml`, `test/unit/test_prop.ml`, new `test/models/bool_*.fzn` + expected | agent-bool2 (succeeds agent-bool, interrupted) | 2026-09-16 |
| M1-T25, M1-T28 | `lib/proof/encoding.ml`, `lib/core/prop/order_reason.ml`, `lib/core/prop/linear.ml`, `docs/PROOF-FORMAT.md` | agent-lazy2 (succeeds agent-lazy, interrupted before any edit) | 2026-09-16 |
