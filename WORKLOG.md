...
|---|---|---|---|
| M1-T57 + M1-T56 | `lib/core/trace.ml`, `lib/core/store.ml` (**add-only**), `test/unit/test_trace.ml`, new `test/models/trace_*.fzn` + their `test/expected/` | agent-trace3 | 2026-09-17 |
| M1-T55 + M1-T46 (the `search.ml` half) | `lib/core/search.ml`, `test/unit/test_engine.ml`, new `test/models/decide_*.fzn` + their `test/expected/` | agent-search3 | 2026-09-17 |
| M1-T51 + M1-T46 (the `test_proof.ml` half) | `lib/proof/writer.ml`, `test/unit/test_proof.ml` | agent-polcheck | 2026-09-17 |
| M1-T53 + M1-T52 | `test/unit/dune` (**lent this round**), new `test/unit/mem_guard.ml`, `test/unit/test_output.ml`, `test/unit/test_compile.ml` | agent-testhyg | 2026-09-17 |
| M1-T48 + M1-T49 | `bin/main.ml`, `scripts/run_model_tests.sh` (**lent this round**), `test/unit/test_endtoend.ml` | agent-cli | 2026-09-17 |
